...
export default function Header() {
  ...
  {/*<img src={Logo} className=" w-[48px] h-[48px] " alt="Flowbite Logo" />*/}
            <Image src="/images/alph-logo.png" alt="logo" width={30} height={30}></Image>
              <span className=" hidden md:block self-center f-f-sm text-tiny  whitespace-nowrap text-white ">Alpha Origins</span>
            </Link>
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
              <ul className=" flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row space-x-8 lg:space-x-11 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent ">
                <li className="py-3">
                  <Link href="/" className="block py-2 px-3 text-white f-f-m text-tiny  rounded md:bg-transparent  md:p-0">Twitter</Link>
                </li>

                <li className="py-3">
                 <Link href="/" className="block py-2 px-3 text-white f-f-m text-tiny rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 ">Telegram</Link>
                </li>
                <li className="py-3">
                <Link href="/" className="block py-2 px-3 text-white f-f-m text-tiny rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 ">
